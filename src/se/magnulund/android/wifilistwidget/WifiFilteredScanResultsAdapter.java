...
public class WifiFilteredScanResultsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            filterScanResultView = inflater.inflate(R.layout.wifi_list_item, parent, false);

            WifiFilteredScanResultsViewHolder holder = new WifiFilteredScanResultsViewHolder();
            holder.ssid = (TextView) filterScanResultView.findViewById(R.id.ssid);
        ...
        holder.signalStrength.setImageResource(MyUtil.getSignalStrengthIcon(MyUtil.getSignalStrength(scanResult.level), filteredScanResult.isCurrentConnection()));
